<div id="container_start_1" class="container container_start mt-2 mb-2 @if($array_data['juego_empezado'] != 0) d-none @endif">
	<div class="card text-center p-3">
		<h2>Benvingut al joc del Penjat <br> ¡Edició Marvel!</h2>
		...
		<div class="row row_list_jugadors row_list_jugadors_list d-none justify-content-center d-flex mt-3">			
		</div>	
